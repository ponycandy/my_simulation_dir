...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_test_NMPC_PluginActivator_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_test_NMPC_PluginActivator_t qt_meta_stringdata_test_NMPC_PluginActivator = {
    {
QT_MOC_LITERAL(0, 25) // "test_NMPC_PluginActivator"
...
const QMetaObject test_NMPC_PluginActivator::staticMetaObject = { {
    ...
    qt_meta_stringdata_test_NMPC_PluginActivator.offsetsAndSize,
    qt_meta_data_test_NMPC_PluginActivator,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_test_NMPC_PluginActivator_t
, QtPrivate::TypeAndForceComplete<test_NMPC_PluginActivator, std::true_type>
...
static constexpr unsigned char qt_pluginMetaData_test_NMPC_PluginActivator[] = {
    'Q', 'T', 'M', 'E', 'T', 'A', 'D', 'A', 'T', 'A', ' ', '!',
