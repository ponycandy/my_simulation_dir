#ifndef VISUALIZER_201_H
#define VISUALIZER_201_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class Visualizer_201Activator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit Visualizer_201Activator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static Visualizer_201Activator *m_instance;
    static PluginContext *m_CONTEXT;
    animator_manager *m_anim;
};
