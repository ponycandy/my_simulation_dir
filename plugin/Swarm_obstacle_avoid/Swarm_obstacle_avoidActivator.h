#ifndef SWARM_OBSTACLE_AVOID_H
#define SWARM_OBSTACLE_AVOID_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class Swarm_obstacle_avoidActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit Swarm_obstacle_avoidActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static Swarm_obstacle_avoidActivator *m_instance;
