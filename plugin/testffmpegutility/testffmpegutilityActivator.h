#ifndef TESTFFMPEGUTILITY_H
#define TESTFFMPEGUTILITY_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class testffmpegutilityActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit testffmpegutilityActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static testffmpegutilityActivator *m_instance;
