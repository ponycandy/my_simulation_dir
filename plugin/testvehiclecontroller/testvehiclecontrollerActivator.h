#ifndef TESTVEHICLECONTROLLER_H
#define TESTVEHICLECONTROLLER_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class testvehiclecontrollerActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit testvehiclecontrollerActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static testvehiclecontrollerActivator *m_instance;
