...
class Vehicle_simulatorActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit Vehicle_simulatorActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static Vehicle_simulatorActivator *m_instance;
    static PluginContext *m_CONTEXT;
    vehicle_manager *m_manager;
};
