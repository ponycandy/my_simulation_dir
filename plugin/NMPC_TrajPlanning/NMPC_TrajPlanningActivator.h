#ifndef NMPC_TRAJPLANNING_H
#define NMPC_TRAJPLANNING_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class NMPC_TrajPlanningActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit NMPC_TrajPlanningActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static NMPC_TrajPlanningActivator *m_instance;
    static PluginContext *m_CONTEXT;
    NMPC_manager *m_manager;
};
