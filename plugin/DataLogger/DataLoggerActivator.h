...
class DataLoggerActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit DataLoggerActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static DataLoggerActivator *m_instance;
    static PluginContext *m_CONTEXT;
    DataloggerManager *m_logger;
};
