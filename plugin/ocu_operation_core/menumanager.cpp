...
void MenuManager::buildMenu(UcsDefines::UcsViewKind viewKind)
{
    ...
    switch (viewKind)
    {
        ...
        {
            setButton(11, QStringLiteral("LOGIN"), UcsEventConstants::MENU_EVENT_LOGIN, QString(":/img/login_pre"));
            setButton(12, QStringLiteral("LOGIN\r\nMANAGEMENT"), UcsEventConstants::MENU_EVENT_LOGIN_ADMIN, QString(":/img/admin_login_pre"));
            break;
        }
