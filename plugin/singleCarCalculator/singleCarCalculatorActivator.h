#ifndef SINGLECARCALCULATOR_H
#define SINGLECARCALCULATOR_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class singleCarCalculatorActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit singleCarCalculatorActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static singleCarCalculatorActivator *m_instance;
