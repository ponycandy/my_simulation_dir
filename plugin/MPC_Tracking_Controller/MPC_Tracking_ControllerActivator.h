#ifndef MPC_TRACKING_CONTROLLER_H
#define MPC_TRACKING_CONTROLLER_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class MPC_Tracking_ControllerActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit MPC_Tracking_ControllerActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static MPC_Tracking_ControllerActivator *m_instance;
    static PluginContext *m_CONTEXT;
    MPC_manager *m_manager;
};
