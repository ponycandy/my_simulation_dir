#ifndef SWARM_NLPSIMULATOR_H
#define SWARM_NLPSIMULATOR_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class swarm_NLPSimulatorActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit swarm_NLPSimulatorActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static swarm_NLPSimulatorActivator *m_instance;
