#ifndef SWARM_PATH_PLANNING_H
#define SWARM_PATH_PLANNING_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class swarm_path_planningActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit swarm_path_planningActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static swarm_path_planningActivator *m_instance;
    static PluginContext *m_CONTEXT;
    planner_manager *m_manager;
};
