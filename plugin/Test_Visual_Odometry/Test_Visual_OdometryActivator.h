#ifndef TEST_VISUAL_ODOMETRY_H
#define TEST_VISUAL_ODOMETRY_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class Test_Visual_OdometryActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit Test_Visual_OdometryActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static Test_Visual_OdometryActivator *m_instance;
