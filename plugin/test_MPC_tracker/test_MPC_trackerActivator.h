#ifndef TEST_MPC_TRACKER_H
#define TEST_MPC_TRACKER_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class test_MPC_trackerActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit test_MPC_trackerActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static test_MPC_trackerActivator *m_instance;
