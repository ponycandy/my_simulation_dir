...
ifopt::Component::VecBound TestPolyParams::GetBounds() const
{
    ...
    b.at(0)=ifopt::BoundSmallerZero;
    b.at(1)=ifopt::BoundSmallerZero;
...
void TestPolyParams::FillinG(Eigen::VectorXd &g) const
{
    ...
    g(0)=actmat(0,1)-actmat(0,0);
    g(1)=actmat(1,1)-actmat(1,0);
}
