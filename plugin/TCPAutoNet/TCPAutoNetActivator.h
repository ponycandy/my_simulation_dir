...
#include "tcpautonetmanager.h"


class TCPAutoNetActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit TCPAutoNetActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static TCPAutoNetActivator *m_instance;
    static PluginContext *m_CONTEXT;
    TCPAutoNetManager *m_manager;
};
