#ifndef MULTIPLECAMERAOPERATOR_H
#define MULTIPLECAMERAOPERATOR_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class MultipleCameraOperatorActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit MultipleCameraOperatorActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static MultipleCameraOperatorActivator *m_instance;
