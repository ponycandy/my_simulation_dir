#ifndef VEHICLE_SWARM_CONTROLLER_H
#define VEHICLE_SWARM_CONTROLLER_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class Vehicle_swarm_controllerActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit Vehicle_swarm_controllerActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static Vehicle_swarm_controllerActivator *m_instance;
    static PluginContext *m_CONTEXT;
    Device_manager *m_manager;
};
