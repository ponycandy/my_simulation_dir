#ifndef PENDULEM_RL_EXPERINECE_H
#define PENDULEM_RL_EXPERINECE_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class Pendulem_rl_experineceActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit Pendulem_rl_experineceActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static Pendulem_rl_experineceActivator *m_instance;
