...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_simmanager_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_simmanager_t qt_meta_stringdata_simmanager = {
    {
QT_MOC_LITERAL(0, 0, 10), // "simmanager"
...
void simmanager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        simmanager *_t = static_cast<simmanager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject simmanager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_simmanager.data,
      qt_meta_data_simmanager,  qt_static_metacall, nullptr, nullptr}
};
