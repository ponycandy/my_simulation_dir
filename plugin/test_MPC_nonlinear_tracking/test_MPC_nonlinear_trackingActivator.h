#ifndef TEST_MPC_NONLINEAR_TRACKING_H
#define TEST_MPC_NONLINEAR_TRACKING_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class test_MPC_nonlinear_trackingActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit test_MPC_nonlinear_trackingActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static test_MPC_nonlinear_trackingActivator *m_instance;
