#ifndef PUSHINGBOX_2D_H
#define PUSHINGBOX_2D_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class pushingbox_2dActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit pushingbox_2dActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static pushingbox_2dActivator *m_instance;
