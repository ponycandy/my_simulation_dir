...
QT_MOC_LITERAL(3, 34, 21), // "QMap<int,SwarmAgent*>"
QT_MOC_LITERAL(4, 56, 14), // "Agents_group_s"
QT_MOC_LITERAL(5, 71, 20), // "sig_obs_state_update"
QT_MOC_LITERAL(6, 92, 24), // "QMap<int,SwarmObstacle*>"
QT_MOC_LITERAL(7, 117, 11) // "obs_group_s"

    },
    "Simulator\0sig_agent_state_update\0\0"
    "QMap<int,SwarmAgent*>\0Agents_group_s\0"
    "sig_obs_state_update\0QMap<int,SwarmObstacle*>\0"
    "obs_group_s"
};
...
void Simulator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_agent_state_update((*reinterpret_cast< QMap<int,SwarmAgent*>(*)>(_a[1]))); break;
        case 1: _t->sig_obs_state_update((*reinterpret_cast< QMap<int,SwarmObstacle*>(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Simulator::*_t)(QMap<int,SwarmAgent*> );
        ...
        {
            typedef void (Simulator::*_t)(QMap<int,SwarmObstacle*> );
...
// SIGNAL 0
void Simulator::sig_agent_state_update(QMap<int,SwarmAgent*> _t1)
{
...
// SIGNAL 1
void Simulator::sig_obs_state_update(QMap<int,SwarmObstacle*> _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
