...
QT_MOC_LITERAL(3, 29, 21), // "QMap<int,SwarmAgent*>"
QT_MOC_LITERAL(4, 51, 10), // "agentgroup"
QT_MOC_LITERAL(5, 62, 21), // "slot_obs_state_update"
QT_MOC_LITERAL(6, 84, 24), // "QMap<int,SwarmObstacle*>"
QT_MOC_LITERAL(7, 109, 9) // "obs_group"

    },
    "MYpainter\0slot_update_state\0\0"
    "QMap<int,SwarmAgent*>\0agentgroup\0"
    "slot_obs_state_update\0QMap<int,SwarmObstacle*>\0"
    "obs_group"
};
...
void MYpainter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slot_update_state((*reinterpret_cast< QMap<int,SwarmAgent*>(*)>(_a[1]))); break;
        case 1: _t->slot_obs_state_update((*reinterpret_cast< QMap<int,SwarmObstacle*>(*)>(_a[1]))); break;
        default: ;
        }
    }
}
