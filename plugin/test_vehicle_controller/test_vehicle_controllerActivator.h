#ifndef TEST_VEHICLE_CONTROLLER_H
#define TEST_VEHICLE_CONTROLLER_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class test_vehicle_controllerActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit test_vehicle_controllerActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static test_vehicle_controllerActivator *m_instance;
