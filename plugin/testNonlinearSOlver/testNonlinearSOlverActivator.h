#ifndef TESTNONLINEARSOLVER_H
#define TESTNONLINEARSOLVER_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class testNonlinearSOlverActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit testNonlinearSOlverActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static testNonlinearSOlverActivator *m_instance;
