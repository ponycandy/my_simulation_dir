#ifndef TRT_INTERFACE_H
#define TRT_INTERFACE_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class trt_InterfaceActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit trt_InterfaceActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static trt_InterfaceActivator *m_instance;
    static PluginContext *m_CONTEXT;
    trtmanager *m_manager;
};
