#ifndef OPENCVGRAPH_H
#define OPENCVGRAPH_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class OpenCVGraphActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit OpenCVGraphActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static OpenCVGraphActivator *m_instance;
