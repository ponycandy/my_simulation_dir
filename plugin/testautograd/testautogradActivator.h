#ifndef TESTAUTOGRAD_H
#define TESTAUTOGRAD_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class testautogradActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit testautogradActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static testautogradActivator *m_instance;
