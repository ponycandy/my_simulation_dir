#ifndef SWARM_TARGET_INCEPT_WITH_OBS_AVOIDENCE_H
#define SWARM_TARGET_INCEPT_WITH_OBS_AVOIDENCE_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class swarm_Target_Incept_with_obs_avoidenceActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit swarm_Target_Incept_with_obs_avoidenceActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static swarm_Target_Incept_with_obs_avoidenceActivator *m_instance;
