...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_simulatorWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_simulatorWidget_t qt_meta_stringdata_simulatorWidget = {
    {
QT_MOC_LITERAL(0, 0, 15) // "simulatorWidget"
...
const QMetaObject simulatorWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_simulatorWidget.data,
      qt_meta_data_simulatorWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *simulatorWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_simulatorWidget.stringdata0))
