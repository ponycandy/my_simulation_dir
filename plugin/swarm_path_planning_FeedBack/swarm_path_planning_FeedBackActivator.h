#ifndef SWARM_PATH_PLANNING_FEEDBACK_H
#define SWARM_PATH_PLANNING_FEEDBACK_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class swarm_path_planning_FeedBackActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit swarm_path_planning_FeedBackActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static swarm_path_planning_FeedBackActivator *m_instance;
