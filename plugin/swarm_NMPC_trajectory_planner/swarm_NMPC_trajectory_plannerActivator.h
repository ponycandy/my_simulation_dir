#ifndef SWARM_NMPC_TRAJECTORY_PLANNER_H
#define SWARM_NMPC_TRAJECTORY_PLANNER_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class swarm_NMPC_trajectory_plannerActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit swarm_NMPC_trajectory_plannerActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static swarm_NMPC_trajectory_plannerActivator *m_instance;
