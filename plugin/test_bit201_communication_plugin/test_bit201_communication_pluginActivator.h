#ifndef TEST_BIT201_COMMUNICATION_PLUGIN_H
#define TEST_BIT201_COMMUNICATION_PLUGIN_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class test_bit201_communication_pluginActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit test_bit201_communication_pluginActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static test_bit201_communication_pluginActivator *m_instance;
    static PluginContext *m_CONTEXT;
    main_executer *m_exec;
};
