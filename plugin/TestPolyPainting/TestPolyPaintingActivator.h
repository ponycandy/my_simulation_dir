#ifndef TESTPOLYPAINTING_H
#define TESTPOLYPAINTING_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class TestPolyPaintingActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit TestPolyPaintingActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static TestPolyPaintingActivator *m_instance;
