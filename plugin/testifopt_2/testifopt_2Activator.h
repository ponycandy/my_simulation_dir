#ifndef TESTIFOPT_2_H
#define TESTIFOPT_2_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class testifopt_2Activator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit testifopt_2Activator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static testifopt_2Activator *m_instance;
