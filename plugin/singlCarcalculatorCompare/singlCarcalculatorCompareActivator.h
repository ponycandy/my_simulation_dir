#ifndef SINGLCARCALCULATORCOMPARE_H
#define SINGLCARCALCULATORCOMPARE_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class singlCarcalculatorCompareActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit singlCarcalculatorCompareActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static singlCarcalculatorCompareActivator *m_instance;
    static PluginContext *m_CONTEXT;
    Solvermanager *m_manager;
