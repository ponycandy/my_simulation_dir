...
#include "singlCarcalculatorCompareActivator.h".h"
#include "xmlcore.h"
Solvermanager::Solvermanager()
{
    m_solver=singlCarcalculatorCompareActivator::getService<NonlinearSolverservice>("NonlinearSolverservice");
    m_decode=singlCarcalculatorCompareActivator::getService<CPYcoderservice>("CPYcoderservice");
