#ifndef TESTOPENCVANDZED_H
#define TESTOPENCVANDZED_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class TestOPencvAndZEDActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit TestOPencvAndZEDActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static TestOPencvAndZEDActivator *m_instance;
