#ifndef SWARM_ETM_COMPARE_H
#define SWARM_ETM_COMPARE_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class swarm_ETM_compareActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit swarm_ETM_compareActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static swarm_ETM_compareActivator *m_instance;
