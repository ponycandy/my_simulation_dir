...
const char SIM_SIMULATIONINIT[]="SIM_SIMULATIONINIT";
const char SIM_CONTROLMODESWITCH[]="SIM_CONTROLMODESWITCH";
const char SIM_DEVICESCONTROL[]="SIM_DEVICESCONTROL";

const char SIM_MISSIONPLAN[]="SIM_MISSIONPLAN";


const char NETCONFIG[]="on_net_config_clicked";
const char SWITCHTOMAP[]="SWITCHTOMAP";
const char DISPLAYSTATUS[]="DISPLAYSTATUS";

const char COMMANDLINEEXEC[]="COMMANDLINEEXEC";


const char SET_MQTT_NET[]="SET_MQTT_NET";
const char STSTEMSHUTDOWN[]="STSTEMSHUTDOWN";

const char MISSIONPLAN[]="MISSIONPLAN";
const char SOURCESWITCH[]="SOURCESWITCH";
